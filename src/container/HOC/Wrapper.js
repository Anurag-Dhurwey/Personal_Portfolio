...
const Wrapper = (Component, idName, classNames) => function HOC() {
  return (
    <div id={idName} style={{padding:idName=="home"?"0 0":''}} className={`${classNames} min-h-[100vh] h-[100%] w-[100%] flex justify-center items-center px-2 pt-4`}>
      <div className='pr-4 max-[681px]:hidden'>
        <LS_Sociel_Icons />
      </div>
      <Component />
      <div className='pl-4 max-[681px]:hidden'>
